...
export default function Welcome(props) {
    ...
    function onTimelineNavigate(data) {
        //HERE IT WORKS!!!!!!!!
        ...
        console.log(year);
        console.log(files);
        //console.log(props.file[data.title]);
    }
    ...
    function ImageList() {
        ...
        if (year === "1950") {
            useEffect(() => {
                function filesFunction(props, data) {
                    console.log(props);
                    setFiles(props.files);
                    console.log(props.files);
                    console.log(files);
                ...
                [files];
            console.log(props.files);
            // return <div>'1950000'</div>;
        } else if (year === "1955") {
            useEffect(() => {
                function filesFunction(props, data) {
                    console.log(props);
                    setFiles(props.filesTwo);
                }
                filesFunction(props);
            }),
                [files];
            console.log(props.filesTwo);
            // return <div>'1955555'</div>;
        } else if (year === "1960") {
            useEffect(() => {
                function filesFunction(props, data) {
                    console.log(props);
                    setFiles(props.filesThree);
                }
                filesFunction(props);
            }),
                [files];
            console.log(props.filesThree);
            // return <div>'1955555'</div>;
        } else if (year === "1965") {
            useEffect(() => {
                function filesFunction(props, data) {
                    console.log(props);
                    setFiles(props.filesFour);
                }
                filesFunction(props);
            }),
                [files];
            console.log(props.filesFour);
            // return <div>'1955555'</div>;
        } else if (year === "1970") {
            useEffect(() => {
                function filesFunction(props, data) {
                    console.log(props);
                    setFiles(props.filesFive);
                }
                filesFunction(props);
            }),
                [files];
            console.log(props.filesFive);
            // return <div>'1955555'</div>;
        } else if (year === "1975") {
            useEffect(() => {
                function filesFunction(props, data) {
                    console.log(props);
                    setFiles(props.filesSix);
                }
                filesFunction(props);
            }),
                [files];
            console.log(props.filesSix);
            // return <div>'1955555'</div>;
        } else if (year === "1980") {
            useEffect(() => {
                function filesFunction(props, data) {
                    console.log(props);
                    setFiles(props.filesSeven);
                }
                filesFunction(props);
            }),
                [files];
            console.log(props.filesSeven);
            // return <div>'1955555'</div>;
        } else if (year === "1985") {
            useEffect(() => {
                function filesFunction(props, data) {
                    console.log(props);
                    setFiles(props.filesEight);
                }
                filesFunction(props);
            }),
                [files];
            console.log(props.filesEight);
            // return <div>'1955555'</div>;
        } else if (year === "1990") {
            useEffect(() => {
                function filesFunction(props, data) {
                    console.log(props);
                    setFiles(props.filesNine);
                }
                filesFunction(props);
            }),
                [files];
            console.log(props.filesNine);
            // return <div>'1955555'</div>;
        } else if (year === "1995") {
            useEffect(() => {
                function filesFunction(props, data) {
                    console.log(props);
                    setFiles(props.filesTen);
                }
                filesFunction(props);
            }),
                [files];
            console.log(props.filesTen);
            // return <div>'1955555'</div>;
        } else if (year === "2000") {
            useEffect(() => {
                function filesFunction(props, data) {
                    console.log(props);
                    setFiles(props.filesEleven);
                }
                filesFunction(props);
            }),
                [files];
            console.log(props.filesEleven);
            // return <div>'1955555'</div>;
        } else if (year === "2005") {
            useEffect(() => {
                function filesFunction(props, data) {
                    console.log(props);
                    setFiles(props.filesTwelve);
                }
                filesFunction(props);
            }),
                [files];
            console.log(props.filesTwelve);
            // return <div>'1955555'</div>;
        } else if (year === "2010") {
            useEffect(() => {
                function filesFunction(props, data) {
                    console.log(props);
                    setFiles(props.filesThirteen);
                }
                filesFunction(props);
            }),
                [files];
            console.log(props.filesThirteen);
            // return <div>'1955555'</div>;
        } else {
            return <div>else statement</div>;
        }
    }
    return (
        <div className="Welcome">
            ...
            {console.log(props.files)}
            {/* <div>{console.log("files", files)}</div> */}
            <div className="move_main_content">
                <Chrono
                    items={meow}
                    useReadMore={false}
                    allowDynamicUpdate={true}
                    onItemSelected={(data) => onTimelineNavigate(data)}
                    cardLess={true}
                    mode="HORIZONTAL"
                ></Chrono>
                <ImageList props={props} year={year} files={files} />
                {/* <h2>Welcome year: {year}</h2>
                <h2>File name: {files}</h2> */}
                <TitlebarImageList year={year} files={files} />
            </div>
        </div>
    );
}
